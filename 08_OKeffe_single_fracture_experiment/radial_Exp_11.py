...
if run:
    ...
    Eprime = 427000   # plain strain modulus
    ...
    Q0 = 2/1000/60/1000  # injection rate
    ...
    simulProp.set_outputFolder("./Data/Exp_11_single_fracture")   # the disk address where the files are saved
...
if plot:
    ...
    Fr_list, properties = load_fractures("./Data/Exp_11_single_fracture")
