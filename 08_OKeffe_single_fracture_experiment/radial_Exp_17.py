...
if run:
    ...
    Eprime = 415000   # plain strain modulus
    ...
    simulProp.set_outputFolder("./Data/Exp_17_single_fracture")   # the disk address where the files are saved
...
if plot:
    ...
    Fr_list, properties = load_fractures("./Data/Exp_17_single_fracture")
