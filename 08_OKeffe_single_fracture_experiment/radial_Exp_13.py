...
if run:
    ...
    Eprime = 213000   # plain strain modulus
    ...
    simulProp.set_outputFolder("./Data/Exp_13_single_fracture")   # the disk address where the files are saved
...
if plot:
    ...
    Fr_list, properties = load_fractures("./Data/Exp_13_single_fracture")
