...
if run:
    ...
    simulProp.set_outputFolder("./Data/Exp_14_single_fracture")   # the disk address where the files are saved
...
if plot:
    ...
    Fr_list, properties = load_fractures("./Data/Exp_14_single_fracture")
