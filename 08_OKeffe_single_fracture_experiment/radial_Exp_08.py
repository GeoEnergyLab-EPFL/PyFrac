...
if run:
    ...
    Eprime = 85000   # plain strain modulus
    youngs_mod = Eprime * (1 - nu**2)   # Young's modulus
    gammas= 4.8                         # J/m^2 surface energy
    ...
    simulProp.set_outputFolder("./Data/Exp_08_single_fracture")   # the disk address where the files are saved
    ...
    simulProp.set_solTimeSeries(np.asarray([39.4,40.]))
...
if plot:
    ...
    Fr_list, properties = load_fractures("./Data/Exp_08_single_fracture")
