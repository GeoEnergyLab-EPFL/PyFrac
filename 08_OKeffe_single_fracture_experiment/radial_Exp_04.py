...
if run:
    ...
    Eprime = 200000   # plain strain modulus
    ...
    Q0 = 35/1000/60/1000  # injection rate
    ...
    simulProp.set_outputFolder("./Data/Exp_04_single_fracture")   # the disk address where the files are saved
...
if plot:
    ...
    Fr_list, properties = load_fractures("./Data/Exp_04_single_fracture")
