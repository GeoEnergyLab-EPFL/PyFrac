...
if run:
    ...
    Eprime = 209000   # plain strain modulus
    youngs_mod = Eprime * (1 - nu**2)   # Young's modulus
    gammas= 5.2                         # J/m^2 surface energy
    ...
    simulProp.set_outputFolder("./Data/Exp_10_single_fracture")   # the disk address where the files are saved
    ...
    simulProp.set_solTimeSeries(np.asarray([14.,48.]))
...
if plot:
    ...
    Fr_list, properties = load_fractures("./Data/Exp_10_single_fracture")
