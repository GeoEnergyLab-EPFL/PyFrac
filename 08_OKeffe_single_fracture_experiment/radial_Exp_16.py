...
if run:
    # creating mesh
    Mesh = CartesianMesh(0.0010, 0.0010, 91, 91)

    # solid properties
    nu = 0.5                            # Poisson's ratio
    Eprime = 489000   # plain strain modulus
    ...
    simulProp.set_outputFolder("./Data/Exp_16_single_fracture")   # the disk address where the files are saved
    ...
    simulProp.set_solTimeSeries(np.concatenate((np.linspace(2.14, 2.15,20),np.asarray([0.76,6.15,10.15,14.15,18.15,22.15,26.15,27.5]))))

    # initializing fracture
    Fr_geometry = Geometry('radial',radius=0.00025)
...
if plot:
    ...
    Fr_list, properties = load_fractures("./Data/Exp_16_single_fracture")
