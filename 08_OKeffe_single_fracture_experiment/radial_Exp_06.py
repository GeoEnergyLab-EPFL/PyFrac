...
if run:
    ...
    Eprime = 129000   # plain strain modulus
    youngs_mod = Eprime * (1 - nu**2)   # Young's modulus
    gammas= 5.6                         # J/m^2 surface energy
    ...
    Q0 = 10/1000/60/1000  # injection rate
    ...
    simulProp.set_outputFolder("./Data/Exp_06_single_fracture")   # the disk address where the files are saved
...
if plot:
    ...
    Fr_list, properties = load_fractures("./Data/Exp_06_single_fracture")
