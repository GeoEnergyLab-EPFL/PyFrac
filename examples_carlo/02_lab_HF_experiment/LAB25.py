...
from pyfrac.solid.elasticity_boundary_effect_get_traction import BoundaryEffect
...
if run:
    # creating mesh
    Mesh = CartesianMesh(0.09/2., 0.09/2., 81, 81)
    ...
    simulProp.finalTime = 0.0014                          # the time at which the simulation stops
