...
if run:
    ...
    simulProp.finalTime = 32                                              # the time at which the simulation stops
    ...
    simulProp.maxCellSize = 0.012

    # initialization parameters
    Fr_geometry = Geometry('radial', radius=0.01, center=[0.0,0.])
...
if export_results:
    ...
    if 9 in to_export:
        print("\n 7) writing ux, qx")
        from pyfrac.utilities.postprocess_fracture import get_velocity_slice
        my_X = 0.01; my_Y = 0.
