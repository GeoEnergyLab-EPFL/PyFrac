...
def export(myfolder, simulation_name, to_export, destination):
    ...
    if export_results:
        ...
        if 1 in to_export:
            myJsonName_1 = destination + "/SJ_"+simulation_name+"_export.json"           # I will export here most of the infos
...
common_address = "C:\\Users\\admin\\PycharmProjects\\PyFrac\\07_Three_stress_layers\\SJ_full_containment"

folders_list = [ common_address + "\\05mtoK"]

destination = common_address + "\\05mtoK"
