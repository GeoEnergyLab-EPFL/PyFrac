...
from pyfrac.utilities.utility import setup_logging_to_console# setting up the verbosity level of the log at console
...
if run:
    ...
    # fluid properties
    Fluid = FluidProperties(viscosity=0.05)
    from pyfrac.utilities.postprocess_fracture import load_fractures
...
if export_results:
    ...
    if 1 in to_export:
        from pyfrac.utilities.visualization import *
        from pyfrac.utilities.postprocess_fracture import append_to_json_file, load_fractures
