...
def get_fracture_variable_whole_mesh(fracture_list, variable, edge=4, return_time=True):
...
def get_fracture_variable_at_point(fracture_list, variable, point, edge=4, return_time=True):
    ...
    var_values, time_list = get_fracture_variable_whole_mesh(fracture_list,
                                                        variable,
                                                        edge=edge)
...
def get_HF_analytical_solution_at_point(regime, variable, point, mat_prop, inj_prop, fluid_prop=None,
    ...
    for i in range(srs_length):
        ...
        value_mesh, mesh = get_HF_analytical_solution_whole_mesh(regime,
                                                                    variable,
                                                                    mat_prop,
                                                                    inj_prop,
                                                                    mesh=mesh,
