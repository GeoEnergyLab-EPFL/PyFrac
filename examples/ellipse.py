...
# creating mesh
Mesh = CartesianMesh(40., 40., 40, 40)
...
simulProp = SimulationParameters(tip_asymptote="K",
                                 output_time_period=0.5,
                                 plot_figure=False,
                                 save_to_disk=True,
                                 out_file_folder=".\\Data\\Ellipse625", # e.g. "./Data/Laminar" for linux or mac
