...
import time
# creating mesh
Mesh = CartesianMesh(1.5,12.5, 31,101)
...
Injection = InjectionProperties(Q0,
                                Mesh,
                                source_coordinates=[0, -10])

# fluid properties
Fluid = FluidProperties(viscosity=1/12, density=1)
...
simulProp.gravity = False                    # set up the gravity flag
...
simulProp.plotVar = ['w','footprint']              # plot fracture width and fracture front velocity
sim_name = "Peirce_2016"
...
Fr_geometry = Geometry('radial',radius=1.25)
