...
simulProp.set_outputFolder("./Data/Mpulse")   # the disk address where the files are saved
...
Fr_list, properties = load_fractures(address="./Data/Mpulse")       # load all fractures
