...
namespace hfp3d{
    ...
    //this script gives several ways to assembler the global influence matrix
...
///////////////////////////////////////////////////////////////////////////////
    ...
    // make_vector:
    // it returns a 2D array which contains the influence coefficients for the first element
    ...
    //      then the make_vector
    il::Array2D<double> make_vector_perp(Mesh mesh); // returning a 2D vector
    il::Array<double>   make_vector_perp_1D(Mesh mesh); // returning a 1D vector
