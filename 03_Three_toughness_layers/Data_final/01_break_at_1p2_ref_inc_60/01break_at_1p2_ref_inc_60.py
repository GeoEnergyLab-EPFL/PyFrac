...
#run = False
#----
run_dir =  "./Data/01_break_at_1p2_ref_inc_60"
#----
restart = True
#----
use_HMAT = False
...
if run:
    ...
    def K1c_func(x,y,alpha):
        ...
        return smoothing(K_Ic, 1.2*K_Ic, r, delta, xp,yp)
    ...
    simulProp.finalTime = 10.12  # the time at which the simulation stops
    ...
    simulProp.simID = 'K1/K2=1.2' # do not use _
    ...
    if restart:
        ...
        Fr_list, properties = load_fractures(address=run_dir,
                                             step_size=100)  # load all fractures                                                # list of times
...
if not os.path.isfile('./batch_run.txt'):  # We only visualize for runs of specific examples
    ...
    Fr_list_A, properties_A = load_fractures(address=output_fol, load_all=True)#time_srs=[0.1,0.64])#load_all=True)  # load all fractures
