...
if run:
    ...
    def K1c_func(x,y,alpha):
        ...
        r = 1.48
        delta = 0.0005
        return smoothing(K_Ic, 1.4*K_Ic, r, delta, x)
    ...
    simulProp.simID = 'K1/K2=1.4' # do not use _
...
if not os.path.isfile('./batch_run.txt'):  # We only visualize for runs of specific examples
    ...
    Fr_list_A, properties_A = load_fractures(address=output_fol, time_srs=[0.4,1.,1.6])#load_all=True)  # load all fractures
