...
from pyfrac.tip.volume_integral import leak_off_stagnant_tip


def injection_same_footprint(
    Fr_lstTmStp,
    C,
    Boundary,
    timeStep,
    ...
    if (
        len(Fr_lstTmStp.InCrack[np.where(Fr_lstTmStp.InCrack == 1)])
        > sim_properties.maxElementIn
    ...
    if sum(mat_properties.Cprime[Fr_lstTmStp.EltCrack]) > 0.0:
        ...
        LkOff[Fr_lstTmStp.EltTip] = leak_off_stagnant_tip(
            Fr_lstTmStp.EltTip,
            Fr_lstTmStp.l,
            Fr_lstTmStp.alpha,
    ...
    if (
        ...
        and Fr_lstTmStp.fronts_dictionary["number_of_fronts"] == 2
    ...
    w_k, p_k, return_data = solve_width_pressure(
        Fr_lstTmStp,  # Fr_lstTmStp
        sim_properties,
        fluid_properties,
        mat_properties,
        inj_properties,
    ...
    if Boundary is not None:
        ...
        Fr_kplus1.pNet[Fr_lstTmStp.EltCrack] = (
            p_k[Fr_lstTmStp.EltCrack]
            - mat_properties.SigmaO[Fr_lstTmStp.EltCrack]
            - Fr_kplus1.boundEffTraction[Fr_lstTmStp.EltCrack]
        )
    else:
        Fr_kplus1.pNet[Fr_lstTmStp.EltCrack] = (
            p_k[Fr_lstTmStp.EltCrack] - mat_properties.SigmaO[Fr_lstTmStp.EltCrack]
        )
