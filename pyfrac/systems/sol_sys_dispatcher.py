...
# Internal imports
from pyfrac.systems.sol_sys_EHL import sol_sys_EHL
from pyfrac.systems.sol_sys_volume_and_load_control import (
    sol_sys_volume_and_load_control,
)


def solve_width_pressure(
    Fr_lstTmStp,
    sim_properties,
    fluid_properties,
    mat_properties,
    ...
    if sim_properties.get_volumeControl():
        return sol_sys_volume_and_load_control(
            Fr_lstTmStp,
            sim_properties,
            fluid_properties,
            mat_properties,
            ...
            inj_same_footprint=inj_same_footprint,
        )
