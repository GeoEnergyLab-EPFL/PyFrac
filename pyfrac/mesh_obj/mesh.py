...
from pyfrac.utilities.visualization import zoom_factory, to_precision, text3d, EPFLcolor
from pyfrac.mesh_obj.symmetry import *
from numba import njit, uint64

# implicit input
from pyfrac.mesh_obj.symmetry import corresponding_elements_in_symmetric, get_symetric_elements, \
...
def process_material_prop_for_display(material_prop, backGround_param):
    ...
    if backGround_param in ['confining stress', 'sigma0']:
        ...
        parameter = r"confining stress ($MPa$)"
        ...
        parameter = r"fracture toughness ($Mpa\sqrt{m}$)"
        ...
        raise ValueError("Back ground color identifier not supported!\n"
                         ...
                         r"-- \'confining stress\' or \'sigma0\'" + "\n"
                         r"-- \'fracture toughness\' or \'K1c\'" + "\n"
                         r"-- \'leak off coefficient\' or \'Cl\'")
