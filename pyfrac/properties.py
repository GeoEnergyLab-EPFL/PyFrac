...
# Internal imports
from pyfrac.utilities.labels import var_labels, supported_variables, units, err_msg_variable, \
...
class SimulationProperties:
    ...
    def __init__(self, address=None):
        ...
        if address is None:
            import pyfrac.default_parameters as simul_param
        else:
            import sys
...
# ----------------------------------------------------------------------------------------------------------------------
    def set_logging_to_file(self, address, verbosity_level=None):
        ...
        from pyfrac.utilities.utility import logging_level
