...
units = {
    ...
    'width': r' ($mm$)',
    'pf': r' ($MPa$)',
    'fluid pressure': r' ($MPa$)',
    'pn': r' ($MPa$)',
    'net pressure': r' ($MPa$)',
    'front velocity': r' ($m/s$)',
    'v': r' ($m/s$)',
    'Reynolds number': '',
    'Re': '',
    'dpdx': r'($MPa/m$)',
    'pressure gradient x': r'($MPa/m$)',
    'dpdy': r'($MPa/m$)',
    'pressure gradient y': r'($MPa/m$)',
    'fluid flux': r' ($m^2/s$)',
    'ff': r' ($m^2/s$)',
    'fluid velocity': r' ($m/s$)',
    'fv': r' ($m/s$)',
    'fluid velocity as vector field': r' ($m/s$)',
    'fvvf': r' ($m/s$)',
    'fluid flux as vector field': r' ($m^2/s$)',
    'ffvf': r' ($m^2/s$)',
    'front_dist_min': r' ($meters$)',
    'd_min': r' ($meters$)',
    'front_dist_max': r' ($meters$)',
    'd_max': r' ($meters$)',
    'front_dist_mean': r' ($meters$)',
    'd_mean': r' ($meters$)',
    'V': r' $m^3$',
    'volume': r' $m^3$',
    'lk': r' $m^3$',
    ...
    'source elements': '',
    'se': '',
    'effective viscosity': r'($Pa\cdot s$)',
    'ev': r'($Pa\cdot s$)',
    'yield ratio': '',
    'y': '',
    'injection line pressure': ' MPa',
    'ilp': ' MPa',
    'injection rate': r' $m^3/s$',
    'ir': r' $m^3/s$',
    'total injection rate': r' $m^3/s$',
    'tir': r' $m^3/s$'
}
...
supported_variables = ['w', 'width', 'pf', 'fluid pressure', 'pn', 'net pressure',
                       ...
                       'yield ratio', 'y', 'injection line pressure', 'ilp', 'injection rate', 'ir',
