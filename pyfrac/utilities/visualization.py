...
# Internal imports
from pyfrac.utilities.postprocess_fracture import griddata, err_msg_variable, get_HF_analytical_solution_at_point, get_fracture_variable, bidimensional_variables, get_HF_analytical_solution, get_fracture_dimensions_analytical, get_fracture_variable_at_point
from pyfrac.properties import PlotProperties, LabelProperties
from pyfrac.utilities.labels import supported_variables, supported_projections, \
...
def plot_fracture_list(fracture_list, variable='footprint', projection=None, elements=None,
    ...
    for i in fracture_list:
        if isinstance(i.mesh, int):
            mesh = fracture_list[i.mesh].mesh
        else:
            mesh = i.mesh
        if mesh.Lx > max_Lx:
            largest_mesh = mesh
